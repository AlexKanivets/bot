...
# Текст главного меню
WELCOME_TEXT = (
    f"<b> 🌐 Добро пожаловать в сервис безопасного интернета ⚡️{PROJECT_NAME}⚡️! 🌐</b>\n\n"
    "<blockquote>"
    "⚡️ <b>Молниеносная скорость — забудьте о компромиссах с производительностью</b>\n"
    "🛡️ <b>Непревзойдённая надёжность — стабильность и безопасность на высшем уровне</b>\n"
    "🌍 <b>Смена локаций</b>\n"
    "💬 <b>Поддержка премиум-класса — ваши вопросы решает команда экспертов</b>\n"
    "📱💻 <b>Безупречная адаптивность — от смартфонов до десктопов, всё под вашим контролем</b>\n"
    f"💰 <b>Реферальная система нового уровня — увеличивайте доход вместе с нами</b>\n"
    "</blockquote>\n"
    f"<b>🔥 Станьте частью ⚡️{PROJECT_NAME}⚡️ и откройте мир безграничных возможностей!</b>\n"
    f"<b>💳 Актуальные тарифы, вы всегда можете увидеть в официальном канале <a href='https://t.me/BibNet_news'>{PROJECT_NAME} | News</a>(закрепленные сообщения)</b>\n\n"
    f"<i><b>🔒 Ознакомьтесь с <a href='https://bib-net.ru/terms.html'>Пользовательским соглашением</a> и <a href='https://bib-net.ru/privacy.html'>Политикой конфиденциальности</a>.</b></i>\n\n"
)

# Описание сервиса
def get_about_vpn(bot_version: str):
    return (
        "<b>🔍🌐 BIB NET - ваш ключ к безопасному интернету</b>\n\n"
        "<b>🚀 Наши сервера</b>\n"
        "<blockquote>"
        "🇳🇱 Нидерланды\n"
        "├─ ⚡️ До 10 Гбит/с/\n"
        ...
        "• 🚫 Нарушители получают перманентный бан\n"
        "</blockquote>\n"
        f"<i><b>🔒 Ознакомьтесь с <a href='https://bib-net.ru/terms.html'>Пользовательским соглашением</a> и <a href='https://bib-net.ru/privacy.html'>Политикой конфиденциальности</a>.</b></i>\n\n"
    )
...
ADD_SUBSCRIPTION_HINT = "\n<blockquote>🔧 <i>Нажмите кнопку ➕ Добавить новую подписку, чтобы настроить подключение</i></blockquote>"
...
KASSAI_PAYMENT_TITLE = "Пополнение баланса ⚡️{PROJECT_NAME}⚡️"
...
HELEKET_PAYMENT_TITLE = "Пополнение баланса ⚡️{PROJECT_NAME}⚡️"
...
FREEZE_SUBSCRIPTION_CONFIRM_MSG = "Вы можете заморозить (отключить) свою подписку на любой удобный срок, если временно не будете пользоваться сервисом. Включить обратно можно будет в этом же меню.\n\n<b>Вы уверены, что хотите заморозить подписку?</b>"
...
def key_message(key, formatted_expiry_date, days_left_message, server_name, country=None, hwid_count: int = 0, tariff_name: str = "", traffic_limit: int = 0, device_limit: int = 0, subgroup_title: str = ""):
    response_message = (
        f"🔑 <b>Ваша подписка:</b>\n\n"
        f"<code>{key}</code>\n\n"
    )
...
TRIAL_INACTIVE_FIRST_MSG = (
    ...
    "Не упусти возможность попробовать наш сервис прямо сейчас.\n"
    "</blockquote>"
...
TRIAL_INACTIVE_BONUS_MSG = (
    ...
    "Теперь у тебя есть еще шанс протестировать наш сервис целых {total_days_formatted}!\n"
    "</blockquote>"
    "Нажми на кнопку ниже, чтобы активировать доступ с бонусом +{extra_days_formatted}! 👇"
)
ZERO_TRAFFIC_MSG = (
    "⚠ <b>Ваша подписка {email} активна, но трафик не используется.</b>\n\n"
...
FALLBACK_MESSAGE = (
    ...
    "Всё, что касается вашей подписки — тарифы, продления, подключение — доступно в <b>личном кабинете</b> 👇"
)
...
INVITE_TEXT_NON_INLINE = "\nПриглашаю тебя пользоваться действительно быстрым сервисом для защиты интернет-трафика вместе:\n\n{referral_link}"
...
INVITE_MESSAGE_TEMPLATE = (
    ...
    "💰 <b>Общий бонус от рефералов:</b> {total_referral_bonus} RUB"
)
...
REFERRAL_OFFERS = [
    {
        "title": "🎁 Бесплатный сервис защиты интернет-трафик на {trial_time_formatted}",
        "description": "✨ Надежный сервис защиты интернет-трафика бесплатно для тебя!",
        "message": "✅ Попробуй наш сервис защиты интернет-трафик бесплатно на {trial_time_formatted}!\n⚡️ Быстрое подключение\n🔒 Безопасный доступ",
    },
    {
        "title": "🚀 Быстрый и безопасный сервис защиты интернет-трафик",
...
TORRENT_BLOCKED_MSG = (
    ...
    "</blockquote>\n\n"
    "❗️ <b>Важно:</b>\n"
    "• Возможно, вы забыли отключить торрент-клиент и сейчас качаете или раздаете торренты через сервис {PROJECT_NAME}\n"
